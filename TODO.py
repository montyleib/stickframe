...
#TODO: Fillets need to be derived from the roof slope property.


#TODO: Read somewhere that you shouldn't use FreeCAD directly instead use an intance of the document.		


#TODO: remove redundant code in makeFloor() and Activitaed
		#TODO: Move this to a makeFloor() command

#TODO: Add global board width
#TODO: Add global centers
